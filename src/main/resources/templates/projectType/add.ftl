			  ...
			  <div class="panel-body">
				<form id="addForm">
				  <div class="form-group">
					...
					<input type="text" onchange="checkType()" class="form-control" id="fname" placeholder="请输入分类名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">简介</label>
					<input type="text" class="form-control" id="fremark" placeholder="请输入分类简介">
				  </div>
        ...
        <script type="text/javascript">
            ...
            function doAdd(){
            	...
            	$.ajax({
            		...
            		url : "${APP_PATH}/projectType/doAdd",
            		beforeSend : function(){
            			var name= $("#fname").val();
            			if(name.trim()==''){
