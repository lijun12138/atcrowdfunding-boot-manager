			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="fname" value="${tag.name }">
				  </div>
				  ...
				  <button type="button" onclick="doUpdate(${tag.id})" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i> 修改</button>
