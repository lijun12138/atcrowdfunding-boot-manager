        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
                  <button id="assignPermission" class="btn btn-success">分配许可</button>
                  <br><br>
        ...
        <script type="text/javascript">
            $(function () {
				...
				var setting = {
					...
					async: {
						enable: true,
						url:"${APP_PATH}/role/loadData?id="+${RequestParameters.id},
           	...
           	$("#assignPermission").click(function(){
				...
				var checkedNodes = treeObj.getCheckedNodes(true); // 获取被选中的节点
           		var data = {};
           		data.roleid=${RequestParameters.id};
           		if(checkedNodes.length>0){
               		...
               		$.ajax({
               			...
               			data : data,
               			beforeSend : function(){
               				loadingIndex = layer.msg('分配许可中', {icon: 16});
                		},
               			success : function(result){
               				layer.close(loadingIndex);
               				if(result.success){
               					layer.msg("分配成功", {time:1000, icon:6, shift:5});
               				}else{
